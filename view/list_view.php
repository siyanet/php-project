...
if(isset($_GET['search_text'])){
  ...
  if($total_pages > 1){
        ...
        for ($i = 1; $i <= $total_pages; $i++){ 
            echo "<li class ='page-item'><a class='page-link'href='?page=" . $i . "&search_text=" . urlencode($search). "'>" . $i . "</a> </li>";
...
elseif(isset($_GET['school_filter'])){
  ...
  if($total_pages > 1){
        ...
        for ($i = 1; $i <= $total_pages; $i++){
            ...
            echo "<li class ='page-item'><a class='page-link'href='?page=" . $i . "&school_filter=" . urlencode($school_name) . "'>" . $i . "</a> </li>";
